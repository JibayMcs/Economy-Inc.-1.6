package fr.fifou.economy.model;
...
public class ModelInformater extends ModelBase
{
    ...
    public ModelInformater()
    {
        this(0.0F, 0.0F, 64, 64);
    }

    public ModelInformater(float scale, float p_i1164_2_, int width, int height)
    {
