...
public class GuiVault2by2Settings extends GuiScreen
{
		...
		private TileEntityBlockVault2by2 tile;
		...
		public GuiVault2by2Settings(TileEntityBlockVault2by2 tile) 
		{
			this.tile = tile;
		}
		...
		private void addPlayerToTileEntity()
		{
		    ...
		    if(playerAdd != null)
		    {
		        ...
		        tile.setOthers(playerAddUUID);
		        tile.addToMax();
		        PacketsRegistery.network.sendToServer(new PacketListNBT(playerAddUUID, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(), true, "add", 0)); 
		    }
		}
		...
		protected void actionPerformed(GuiButton button) throws IOException 
		{
			...
			case 0:
				tile.removeToMax();
				tile.getOthers().remove(0);
				PacketsRegistery.network.sendToServer(new PacketListNBT("", tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(), true, "remove", 0));
		        break;
			case 1:
				tile.removeToMax();
				tile.getOthers().remove(1);
				PacketsRegistery.network.sendToServer(new PacketListNBT("", tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(), true, "remove", 1));
		        break;
			case 2:
				tile.removeToMax();
				tile.getOthers().remove(2);
				PacketsRegistery.network.sendToServer(new PacketListNBT("", tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(), true, "remove", 2));
		        break;
			case 3:
				tile.removeToMax();
				tile.getOthers().remove(3);
				PacketsRegistery.network.sendToServer(new PacketListNBT("", tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(), true, "remove", 3));
		        break;
			case 4:
				tile.removeToMax();
				tile.getOthers().remove(4);
				PacketsRegistery.network.sendToServer(new PacketListNBT("", tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(), true, "remove", 4));
		        break;
			}
		}
